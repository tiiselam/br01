/****** Object:  StoredProcedure [dbo].[SPED_Total_Saldo_Cta_Open]    Script Date: 5/16/2018 12:59:58 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	begin
		...
		set @debito=(SELECT isnull(abs(sum(DEBITAMT)),0)
			FROM gl10110 where ((PERIODID<@periodid and YEAR1=@year1)) and ACTINDX=@actindx)
	end
	if @TipoTotal=3 
	begin
		set @credito=isnull((SELECT isnull(abs(sum(CRDTAMNT)),0)
...
END
/****** Object:  StoredProcedure [dbo].[SPED_Total_Saldo_Cta_Hist]    Script Date: 5/14/2018 6:00:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[SPED_ArchivoTXT_Open]    Script Date: 5/16/2018 12:47:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	<Description,,>
-- =============================================
create PROCEDURE [dbo].[SPED_ArchivoTXT_Open] 
